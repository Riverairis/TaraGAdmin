...
const AdminDashboard = ({ onLogout }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900 dark:text-white">
      ...
      {/* Mobile Menu Button */}
      <button
        className="md:hidden fixed top-4 left-4 z-30 p-2 bg-cyan-600 dark:bg-cyan-700 text-white rounded-lg shadow-md hover:bg-cyan-700 dark:hover:bg-cyan-600 transition-colors"
        ...
        {activeSection === 'home' && (
          <div className="p-6 md:p-8">
            <div className="max-w-7xl mx-auto">
              {/* Welcome Banner */}
              <div className="bg-gradient-to-r from-cyan-500 to-blue-500 dark:from-cyan-600 dark:to-blue-600 text-white p-8 rounded-2xl shadow-lg relative overflow-hidden mb-8">
                <div className="flex flex-col md:flex-row justify-between items-center relative z-10">
                  <div className="mb-6 md:mb-0">
                    <h1 className="text-3xl md:text-4xl font-bold mb-2">Hello, {adminName}!</h1>
                    <p className="text-cyan-100 dark:text-cyan-200 text-lg">Welcome to the TaraG Administrator Panel</p>
                  </div>
                </div>
